...
//izpolzvame tova za da runvame sushtite testove za secretWord=null i secretWord='party'
//loadingShows i appShows sa boolean zaradi loadera
//%s znachi purvia argument
describe.each([
  [null, true, false],
  ['party', false, true]
])(
